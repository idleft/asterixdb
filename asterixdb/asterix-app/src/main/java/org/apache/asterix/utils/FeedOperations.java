...
public class FeedOperations {
    ...
    private static JobSpecification getConnectionJob(MetadataProvider metadataProvider, FeedConnection feedConnection,
            String[] locations, ILangCompilationProvider compilationProvider,
        ...
        IStatementExecutor translator = qtFactory.create(statements, pc, compilationProvider, storageComponentProvider);
