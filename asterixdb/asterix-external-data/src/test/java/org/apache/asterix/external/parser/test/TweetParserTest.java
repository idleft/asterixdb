...
//        BuiltinType.ADOUBLE,BuiltinType.ASTRING,BuiltinType.ASTRING};
        String[] tweetFieldNames = new String[]{Tweet.ID, Tweet.RETWEET_COUNT,
                Tweet.CREATED_AT, Tweet.TEXT};
        IAType[] tweetFieldTypes = new IAType[]{BuiltinType.AINT64,BuiltinType.AINT32,
                BuiltinType.ADATETIME,BuiltinType.ASTRING};
        ...
        System.out.println(record.get().getCreatedAt().getTime());
