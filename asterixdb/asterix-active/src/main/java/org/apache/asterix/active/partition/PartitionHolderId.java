...
public class PartitionHolderId implements Serializable {
    ...
    public PartitionHolderId(EntityId entityId, String runtimeName, int partition) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PartitionHolderId)) {
            return false;
        }
        PartitionHolderId other = (PartitionHolderId) o;
