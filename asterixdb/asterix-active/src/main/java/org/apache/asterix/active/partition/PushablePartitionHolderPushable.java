...
public abstract class PushablePartitionHolderPushable extends AbstractUnaryOutputSourceOperatorNodePushable
        implements IPushablePartitionHolderRuntime {
    ...
    public PushablePartitionHolderPushable(IHyracksTaskContext ctx, PartitionHolderId phid) {
        this.ctx = ctx;
    ...
    public abstract void start() throws HyracksDataException;
}
