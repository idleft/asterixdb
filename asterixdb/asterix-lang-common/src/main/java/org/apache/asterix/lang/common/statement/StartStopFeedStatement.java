...
public class StartStopFeedStatement implements Statement{

    private Identifier dataverseName;
    private Identifier feedName;
    private Byte stmtType;

    public StartStopFeedStatement(Pair<Identifier, Identifier> feedNameComp, String type){
        dataverseName = feedNameComp.first;
        feedName = feedNameComp.second;
        this.stmtType = type == "start" ? Kind.START_FEED : Kind.STOP_FEED;
    }
