...
import org.apache.hyracks.dataflow.std.connectors.MToNHashCombinePartitioningConnectorDescriptor;

import java.util.Arrays;
import java.util.HashSet;
import java.util.List;

public class HashCombinePartitionExchangePOperator extends AbstractExchangePOperator {
