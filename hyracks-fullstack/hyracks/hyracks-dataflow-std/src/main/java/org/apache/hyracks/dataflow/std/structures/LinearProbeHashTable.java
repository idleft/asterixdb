...
public class LinearProbeHashTable implements ISerializableTable {
    ...
    private static final int DEFAULT_BF_SIZE = 64;
    ...
    public LinearProbeHashTable(int totalTupleCount, final IHyracksFrameMgrContext ctx, int bloomFilterSize) {
        this.ctx = ctx;
    ...
    public LinearProbeHashTable(int totalTupleCount, final IHyracksFrameMgrContext ctx) {
        this(totalTupleCount, ctx, DEFAULT_BF_SIZE);
    }
